...
Для воспроизводимой упаковки используется Python 3.12 и версии из requirements-build.txt. Сборщик отклоняет другие версии Python; запуск исходников допускает Python 3.12+.
